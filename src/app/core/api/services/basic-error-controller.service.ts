...
class BasicErrorControllerService extends __BaseService {
  static readonly errorHtmlUsingGETPath = '/api/error';
  static readonly errorHtmlUsingHEADPath = '/api/error';
  static readonly errorHtmlUsingPOSTPath = '/api/error';
  static readonly errorHtmlUsingPUTPath = '/api/error';
  static readonly errorHtmlUsingDELETEPath = '/api/error';
  static readonly errorHtmlUsingOPTIONSPath = '/api/error';
  static readonly errorHtmlUsingPATCHPath = '/api/error';
